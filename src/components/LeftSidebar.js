...
const UserProfile = () => {
    ...
    return <React.Fragment>
        {/*<div className="media user-profile mt-2 mb-2">
            <img src={logo} className="avatar-sm rounded-circle mr-2" alt="Crol" />
            <img src={logo} className="avatar-xs rounded-circle mr-2" alt="Crol" />

            <div className="media-body">
                <h6 className="pro-user-name mt-0 mb-0">{user.empresa}</h6>
...
const SideNav = () => {
    ...
    return (
        <Fragment>
            ...
            <div className="sidebar-menu ml-3">
                <ul className="metismenu">
                    <li className="side-nav-item">
                        <Link to={'/'} onClick={closeWindow} className="side-nav-link-ref side-sub-nav-link side-nav-link">
                            <span className="uil uil-power">Salir</span>
                        </Link>
                    </li>
                </ul>
            </div>
