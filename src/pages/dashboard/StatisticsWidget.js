                ...
                <div className="pb0 p-3  border-bottom">
                    <div className="row">
                        ...
                        <div className="col-9 text-right">
                            <span className="text-muted text-uppercase font-size-12 font-weight-bold">
                                {props.description}
                            </span>
                    ...
                    <div>
                        ...
                        <p className="font-size-13">
                            <i className={classNames('mr-1 font-size-10 footicon uil', props.iconSmallFootClass)}></i>
